...
console.log(process.env.dbport)
    ...
    const sequelize = new Sequelize(`postgres://${process.env.user}:${process.env.password}@myPort-postgres:${process.env.dbport}/${process.env.databaseName}`, {dialect: process.env.database})
